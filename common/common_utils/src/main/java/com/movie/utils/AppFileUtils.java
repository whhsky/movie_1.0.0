...
public class AppFileUtils {
	 ...
	 * 设置默认图片地址
	 */
	public static final String DEFAULT_CAR_IMG = "images/default_car_image.jpg";
	 ...
	 *
	 */
	public static String PATH = System.getProperty("user.dir") + "/static/upload/";
//	public static String PATH = System.getProperty("user.dir") + "/test/static/upload/";
...
//	}
	...
	public static void deleteFileUsePath(String path) {
		String replacePath = path.replace("static/upload/", "");
		String realPath=PATH+replacePath;
		//根据文件
    ...
    public static String updateFileName(String carimg,String suffix) {
		...
		try{
			...
			if (file.exists()){
				...
				return "static/upload/" + carimg.replace(suffix,"");
			}
		}catch (Exception e){
			e.printStackTrace();
		}
